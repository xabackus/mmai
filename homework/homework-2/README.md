...
The fusion experiments here taught us that naive multimodal fusion on EgoBlind overfits quickly — which is why we opted for frozen CLIP features + lightweight MLP in the final project's urgency classifier instead of end-to-end training. The contrastive learning section was essentially a prototype of what became our CLIP urgency classifier (0.905 ROC-AUC).
