"""
generate_dpo_pairs_vision_sft_nonurgent.py

Generate DPO training pairs from the SFT non-urgent vision model.
...
SFT_ADAPTER = os.path.expanduser("~/LLaMA-Factory/output/sft_nonurgent_vision_v2")
TRAIN_CSV = os.path.expanduser("~/train_labeled.csv")
FRAMES_DIR = os.path.expanduser("~/train")
OUTPUT_PATH = os.path.expanduser("~/LLaMA-Factory/data/egoblind_nonurgent_dpo_sft.json")
CHECKPOINT_PATH = os.path.expanduser("~/dpo_sft_nonurgent_checkpoint.json")
...
def main():
    ...
    info["egoblind_nonurgent_dpo_sft"] = {
        "file_name": "egoblind_nonurgent_dpo_sft.json",
        "formatting": "sharegpt",
        "ranking": True,
        "columns": {
